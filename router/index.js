...
const router = new Router({
  routes: [
    ...
    //   component: resolve => {
    //     axios
    //       .get(`/views/vuci-app-wizard.js?_t=${new Date().getTime()}`)
    //       .then(r => {
    ...
    },
    {
      path: '*',
      components: {
        default: () => import('@/components/404.vue')
      }
    }
  ]
})

// const firstTimeLog = true
// cia tikrina ar user'is prisilogines
// jei ne - turi logintis
